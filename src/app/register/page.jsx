    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold gradient-text">Join CardVault</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow-lg p-8 space-y-6">
          ...
          {/* Photo URL Field */}
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-gray-700">Photo URL (Optional)</label>
            <div className="relative">
        ...
        <div className="text-center space-y-4">
          <p className="text-gray-600">
            ...
            <Link href="/login" className="text-indigo-600 font-bold hover:text-purple-600">
              Login Here
            </Link>
          </p>
        </div>
